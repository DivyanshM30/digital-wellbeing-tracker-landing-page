      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="flex items-center justify-between mt-6">
            ...
            <div className="flex gap-2" role="tablist" aria-label="Carousel slide indicators">
          ...
          <p className="text-center mt-4 text-foreground/60 text-sm" id={`slide-${current}`}>
            {demoScreens[current].caption}
          </p>
        </div>
      </div>
    </section>
